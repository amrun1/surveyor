...
<template>
    <aside :class="ui.isMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        class="fixed inset-y-0 left-0 pt-16 lg:pt-0 w-72 bg-white border-r border-slate-200/80 z-50 transition-transform duration-300 ease-in-out flex flex-col lg:static select-none h-screen overflow-hidden">
